...
<template>
    ...
    <div class="sm:hidden mb-4">
        ...
        <div class="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
            ...
            <div class="relative">
              <input
                ...
                v-model.number="filterForm.rateFrom"
                class="input-filter w-full pl-10"
              />
            ...
            <div class="relative">
              <input
                type="text"
                placeholder="Rate To"
                v-model.number="filterForm.rateTo"
                class="input-filter w-full pl-10"
              />
              <i class="fas fa-pound-sign absolute top-3 left-3 text-gray-400"></i>
            </div>
      ...
      <select
        id="category"
        class="w-full sm:w-36 md:w-48 px-3 py-2 border font-medium  border-purple-500 text-gray-400 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
    ...
    const filterForm = useForm({
      ...
      rateFrom: props.filters.priceFrom ?? null,
      rateTo: props.filters.priceTo ?? null,
      ...
      const clear = () => {
        filterForm.rateFrom = null
        filterForm.rateTo = null
